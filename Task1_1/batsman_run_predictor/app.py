...
with col3:
    avg_4s = st.number_input('Average_4s',min_value=0,step=0.001)
with col4:
...
with col5:
    avg_bf = st.number_input('Average_ball_faced',min_value=0,step=0.001)
with col6:
    avg_sr = st.number_input('Average_strike_rate',min_value=0,step=0.001)
with col7:
    avg_mins = st.number_input('Average_minutes',min_value=0,step=0.001)
